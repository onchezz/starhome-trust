...
pub mod InvestmentComponent {
    ...
    pub trait IInvestmentTrait<TContractState> {
        ...
        fn get_investors_for_asset(self: @TContractState, investment_id: felt252) -> Array<ContractAddress>;
    ...
    > of IInvestmentTrait<ComponentState<TContractState>> {
        fn initialize_investment(
            ...
            self.investment_token.write(investment_id, IERC20Dispatcher { contract_address: token });
        ...
        fn invest(ref self: ComponentState<TContractState>, investment_id: felt252, amount: u256) -> bool {
            ...
            if current_investment == 0 {
                ...
                let mut investors = self.investors_per_asset.read(investment_id);
        ...
        fn get_investors_for_asset(
            ...
            self.investors_per_asset.read(investment_id)
        }
